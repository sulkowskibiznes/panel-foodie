...
export const copy = {
  ...
  pakiet: {
    ...
    banery: {
      ...
      szkic: "Ten pakiet jest jeszcze w przygotowaniu.",
    },
    ...
    komentarze: {
      ...
      dodaj: "Dodaj uwagę",
      doPakietu: "Uwaga do całego pakietu",
  ...
  harmonogram: {
    ...
    poprzedni: "Poprzedni pakiet",
    nastepny: "Następny pakiet",
    okres: "Okres",
    brak: "Nie ma zaplanowanych publikacji w tym okresie.",
    brakPakietu: "Nie ma jeszcze pakietu z harmonogramem. Gdy przygotujemy materiały, zobaczysz tu daty publikacji.",
    lista: "Lista publikacji",
    kampanie: "Kampanie w tym okresie",
    bezKampanii: "W tym okresie nie ma kampanii reklamowej.",
    skomentuj: "Skomentuj",
    zobacz: "Zobacz",
  ...
  zespol: {
    ...
    pakietyMaterialow: {
      tytul: "Materiały",
      opis: "Pakiety tego klienta, każdy na okres od-do (np. 20.09 do 19.10). Nowy pakiet zakładasz w kreatorze na wklejanych linkach do folderów na Dysku.",
      ...
      akcje: {
        ...
        autoOpis: "Domyślnie z karty klienta. Odznacz, gdy ten pakiet ma czekać na ręczną decyzję.",
    ...
    materialy: {
      ...
      nowy: {
        tytul: "Nowy materiał",
        opis: "Plik z komputera albo link do pojedynczego pliku na Dysku.",
        typ: "Rodzaj",
        kampania: "Kampania",
      ...
      potwierdzenie: {
        ...
        opis: "Klient zaakceptował ten pakiet. Po zmianie materiał dostanie plakietkę, klient zobaczy baner o podmianie, a zespół dostanie powiadomienie.",
    ...
    kreator: {
      ...
      krokKlient: "1. Klient i okres",
      krokContent: "2. Folder z contentem",
      krokKampanie: "3. Kampanie",
      od: "Od",
      do: "Do",
      okresOpis: "Okres, na który przygotowujemy materiały, np. 20.09 do 19.10. Wpisz obie daty; kolejny pakiet może zacząć się dowolnego dnia.",
      miesiacWspolpracyPole: "Miesiąc współpracy",
      miesiacWspolpracyOpis: "Podpowiadamy numer o jeden większy niż w ostatnim pakiecie klienta. Po przerwie we współpracy popraw go ręcznie.",
      okresNachodzi: "Ten okres zachodzi na inny pakiet klienta: {pakiety}. Sprawdź daty, jeśli to nie jest celowe.",
      lokal: "Lokal",
      ...
      importPoUtworzeniu: "Po utworzeniu pakietu przejdziesz do karty weryfikacyjnej tego folderu. Panel nie zgaduje ścieżek na Dysku: importuje wyłącznie to, co wkleisz.",
      kampanieOpis: "Kampanii bywa kilka w jednym pakiecie: standardowa, na imprezy okolicznościowe, na polubienia strony. Każda ma własny folder z reklamami.",
      ...
      bledy: {
        ...
        brakOkresu: "Wpisz datę początku i datę końca okresu.",
        zlyOkres: "Data zakończenia nie może być wcześniejsza niż data początku.",
        zaDlugiOkres: "Okres pakietu może trwać najwyżej rok. Sprawdź daty.",
      },
    },
    import: {
      tytul: "Import z Dysku",
      opis: "Trzy kroki: sprawdzasz kartę weryfikacyjną każdego folderu, potwierdzasz, która grafika ma który opis, a potem panel kopiuje pliki w tle. Nic nie trafia do bazy bez Twojego potwierdzenia.",
      nieSkonfigurowany: "Import z Dysku nie jest jeszcze skonfigurowany na tym serwerze (konto usługi Google). Materiały dodasz przyciskiem „Dodaj materiał\".",
      tylkoSzkic: "Import z Dysku działa w szkicu. Po wysyłce dodawaj i podmieniaj materiały pojedynczo, także linkiem do pliku na Dysku.",
      bezFolderow: "Ten pakiet nie ma jeszcze linków do folderów. Wklej link do folderu z contentem albo do folderu z reklamami przy kampanii.",
      przyciskWPakiecie: "Importuj z Dysku",
      krokWeryfikacja: "1. Karta weryfikacyjna",
      krokMapowanie: "2. Mapowanie: grafika i opis",
      krokImport: "3. Kopiowanie plików",
      karta: {
        content: "Folder z contentem",
        reklamy: "Folder z reklamami: {kampania}",
        brakLinku: "Bez linku. Wklej link do folderu, żeby go zaimportować, albo zostaw pusty: ten folder zostanie pominięty.",
        nieZnaleziono: "Nie znaleziono folderu albo konto usługi go nie widzi. Sprawdź link i udostępnienie folderu „Materiały klientów\" dla konta usługi.",
        zablokowany: "Ten folder leży poza „Materiałami klientów\". Import zablokowany, bez obejścia. Wklej link do folderu z właściwego miejsca na Dysku.",
        sciezka: "Ścieżka na Dysku",
        pliki: "Pliki",
        plikiOpis: "{obrazy} grafik, {wideo} wideo, {dokumenty} dokumentów, {inne} innych",
        zmodyfikowano: "Ostatnia zmiana",
        pierwsze: "Pierwsze pliki",
        ...
        ostrzezenie: {
          klient: "Folder klienta na Dysku nazywa się „{folder}\", a wybrany klient to „{klient}\". Upewnij się, że to właściwy klient.",
          miesiac: "W nazwie folderu jest miesiąc {wNazwie}, a ten pakiet to {oczekiwany}. miesiąc współpracy. Sprawdź, czy to właściwy miesiąc.",
          miesiacKalendarzowy: "W nazwie folderu jest „{wNazwie}\", a ten pakiet zaczyna się w miesiącu {oczekiwany}.",
          okres: "W nazwie folderu jest okres {wNazwie}, a ten pakiet zaczyna się w {oczekiwany}. Sprawdź, czy to właściwy okres.",
          powtorny: "Ten folder był już użyty w pakiecie „{tytul}\" ({okres}){data}. To główne zabezpieczenie przed materiałami z innego miesiąca.",
          powtornyData: ", import {data}",
          powtornyLink: "Otwórz tamten pakiet",
          brakPodfolderow: "W folderze nie ma podfolderów „1. Posty\" i „2. Relacje\". Wszystkie grafiki potraktujemy jak posty; relacje przestawisz w mapowaniu.",
          pusty: "Folder jest pusty.",
          nieobslugiwane: "Pominiemy pliki w nieobsługiwanym formacie: {nazwy}. Panel przyjmuje JPG, PNG, WEBP, HEIC, MP4 i MOV.",
          duzeWideo: "Wideo powyżej 150 MB: {nazwy}. Zaimportujemy, ale sprawdź, czy da się je odchudzić.",
        },
        bladLimitu: "Import przerwany: plik „{nazwa}\" waży {waga}, a limit to {limit}. Zmniejsz plik na Dysku i sprawdź folder ponownie.",
        bladDysku: "Nie udało się odczytać folderu z Dysku: {komunikat}",
        ignoruj: "Rozumiem ostrzeżenia i importuję mimo to",
        ignorujWymagane: "Zaznacz przy każdym folderze z ostrzeżeniami, że je rozumiesz, albo popraw link.",
        zmienLink: "Zmień link",
        anulujZmiane: "Anuluj",
        zapiszLink: "Zapisz i sprawdź ponownie",
        sprawdzPonownie: "Sprawdź ponownie",
        pomin: "Pomiń ten folder",
        pominiety: "Folder pominięty. Materiały z niego dodasz później.",
        przywroc: "Jednak importuj",
      },
      dalej: "Dalej: mapowanie",
      dalejBrak: "Żaden folder nie nadaje się do importu. Popraw linki albo dodaj materiały ręcznie.",
      przygotowujemy: "Czytamy foldery i dokumenty...",
      mapowanie: {
        tytul: "Mapowanie",
        opis: "Sprawdź, która grafika ma który opis, i popraw, co trzeba. Nic nie trafi do bazy, dopóki nie klikniesz „Importuj\".",
        posty: "Posty i Reels",
        relacje: "Relacje",
        brakMaterialow: "Brak grafik ani wideo w tym folderze.",
        rodzaj: "Rodzaj",
        rodzaje: { post: "Post", reels: "Reels", relacja: "Relacja" },
        tytulPola: "Robocza nazwa",
        opisPola: "Opis",
        opisZDokumentu: "Opis z dokumentu",
        bezOpisu: "Bez opisu (uzupełnisz w edycji materiału)",
        wybierzOpis: "Wybierz opis",
        dopasowanie: { numer: "Dopasowano po numerze", dokument: "Dopasowano po numerze w nazwie dokumentu", kolejnosc: "Dopasowano po kolejności, sprawdź", brak: "Bez opisu" },
        pliki: "{n} plików",
        slajdy: "Karuzela: {n} slajdów",
        pomin: "Pomiń",
        przywroc: "Przywróć",
        pominiety: "Pominięty",
        podzialDokumentu: "Podgląd podziału dokumentu „{nazwa}\"",
        sekcja: "Sekcja {numer}",
        sekcjaBezNumeru: "Sekcja bez numeru",
        wstep: "Tekst przed pierwszym nagłówkiem",
        nieuzyte: "Opisy, które nie trafiły do żadnego materiału",
        reklama: "Reklama: {kampania}",
        grafiki: "Grafiki",
        teksty: "Teksty",
        naglowki: "Nagłówki",
        opisReklamy: "Opis (pod nagłówkiem)",
        cta: "Przycisk",
        link: "Link",
        zDokumentu: "Z dokumentu: {nazwy}",
        bezSekcji: "Dokument nie ma sekcji „Teksty\" i „Nagłówki\", więc wszystko trafiło do tekstów. Popraw ręcznie.",
        bezDokumentu: "W folderze nie ma dokumentu z tekstami. Uzupełnisz je w edycji reklamy.",
        dodajTekst: "Dodaj tekst",
        dodajNaglowek: "Dodaj nagłówek",
        usun: "Usuń",
        podsumowanie: "Do importu: {materialy} materiałów i {pliki} plików.",
        importuj: "Importuj",
        importujemy: "Uruchamiamy import...",
        wstecz: "Wróć do weryfikacji",
        nicDoImportu: "Nic do importu. Przywróć przynajmniej jeden materiał albo grafikę.",
      },
      postep: {
        tytul: "Kopiowanie plików",
        opis: "Import idzie w tle. Możesz zamknąć tę stronę; postęp zobaczysz po powrocie.",
        rodzaj: { content: "Content", reklamy: "Reklamy: {kampania}", dodatkowy: "Dodatkowy materiał", podmiana: "Podmiana" },
        status: { oczekuje: "Czeka w kolejce", trwa: "Trwa", zakonczony: "Zakończony", blad: "Błąd" },
        pliki: "{gotowe} z {razem} plików",
        zawieszone: "Import się zatrzymał (serwer przerwał pracę w połowie). Wznów, żeby dokończyć od miejsca, w którym stanął.",
        wznow: "Wznów import",
        ponow: "Ponów",
        ostrzezenia: "Ostrzeżenia",
        gotowe: "Import zakończony. Uzupełnij daty publikacji w harmonogramie i sprawdź podgląd oczami klienta.",
        otworzPakiet: "Otwórz pakiet",
        nowyImport: "Nowy import",
      },
      bledy: {
        zablokowany: "Jeden z folderów leży poza „Materiałami klientów\". Import zablokowany.",
        zle_dane: "Dane mapowania nie zgadzają się z zawartością folderu. Wróć do weryfikacji i spróbuj ponownie.",
        nic_do_importu: "Nic do importu.",
        tylko_szkic: "Import z Dysku działa tylko w szkicu.",
        w_toku: "Poprzedni import jeszcze trwa. Poczekaj, aż się skończy.",
        nie_skonfigurowany: "Import z Dysku nie jest skonfigurowany na tym serwerze.",
        brak_kampanii: "Kampania z mapowania nie istnieje już w pakiecie. Odśwież stronę.",
        dysk: "Dysk nie odpowiada: {komunikat}",
        pobieranie: "Nie udało się pobrać pliku „{nazwa}\" z Dysku.",
        magia: "Plik „{nazwa}\" nie jest obrazem ani wideo w obsługiwanym formacie.",
        limit: "Import przerwany: plik „{nazwa}\" waży {waga}, a limit to {limit}.",
        brak_reklamy: "Kampania nie ma materiału reklamowego. Odśwież stronę.",
        ogolny: "Import przerwany przez błąd serwera. Ponów; jeśli błąd się powtórzy, napisz do Szymona.",
      },
      ostrzezeniaZadania: {
        juzWPakiecie: "Pominięto „{nazwa}\": ten plik z Dysku jest już w pakiecie.",
        bezPodgladu: "„{nazwa}\": nie udało się zrobić podglądu (HEIC). Klient zobaczy oryginał, jeśli jego przeglądarka go otworzy.",
        duzeWideo: "„{nazwa}\" waży ponad 150 MB.",
        powtorzonyTekst: "Pominięto powtórzony tekst albo nagłówek reklamy.",
      },
      plikZDysku: {
        etykieta: "albo wklej link do pliku na Dysku",
        pobierz: "Pobierz z Dysku",
        pobieranie: "Pobieramy plik z Dysku...",
        bledy: {
          zlyLink: "To nie jest link do pliku na Dysku Google.",
          folder: "To link do folderu. Do pojedynczego materiału wklej link do pliku (Udostępnij, Kopiuj link).",
          nieZnaleziono: "Nie znaleziono pliku albo konto usługi go nie widzi.",
          zablokowany: "Ten plik leży poza „Materiałami klientów\". Panel nie importuje plików spoza nich.",
          nieSkonfigurowany: "Import z Dysku nie jest skonfigurowany na tym serwerze.",
          dysk: "Dysk nie odpowiada. Spróbuj za chwilę.",
        },
      },
    },
    ...
    harmonogram: {
      ...
      pozaOkresem: "Poza tym okresem",
      pozaOkresemOpis: "Materiały z datą poza okresem pakietu. Przeciągnij je na dzień w siatce albo zmień okres w ustawieniach.",
      kampanie: "Kampanie reklamowe w tym okresie",
      bezKampanii: "Brak kampanii.",
      brakPakietow: "Ten klient nie ma jeszcze pakietu. Załóż go w zakładce Materiały.",
      pakiet: "Pakiet",
      okresPakietu: "Okres pakietu",
      od: "Od",
      do: "Do",
      okresPakietuOpis: "Od pierwszego do ostatniego dnia publikacji z planu contentu. Siatka kalendarza obejmuje ten okres; kolejny pakiet może zacząć się dowolnego dnia.",
      ...
      podglad: "Podgląd",
      typ: { post: "Post", relacja: "Relacja", reels: "Reels", reklama: "Reklama" },
      bledy: { zlaData: "Wpisz poprawną datę.", zlyOkres: "Data zakończenia nie może być wcześniejsza niż data początku, a okres nie może trwać dłużej niż rok.", zleGodziny: "Wpisz od 1 do 6 godzin z zakresu 0-23, po przecinku." },
      },
    ...
    skrzynka: {
      ...
      doPakietu: "Cały pakiet",
      typ: { post: "Post", relacja: "Relacja", reels: "Reels", reklama: "Reklama", pakiet: "Cały pakiet" },
      otworzPakiet: "Otwórz pakiet",
      odpowiedzi: "{n} odp.",
